...
describe("BracketView", () => {
  ...
  it("should render with empty matches", () => {
    renderWithRouter(<BracketView matches={[]} teams={mockTeams} />);
  ...
  it("should show current round when provided", () => {
    renderWithRouter(
      <BracketView matches={[]} teams={mockTeams} currentRound="semifinal" />,
    );
  ...
  it("should handle matches render correctly", () => {
    ...
    renderWithRouter(<BracketView matches={mockMatches} teams={mockTeams} />);
