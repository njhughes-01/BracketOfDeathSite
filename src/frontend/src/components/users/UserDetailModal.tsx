                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div className="space-y-3">
                    ...
                    {onToggleStatus && (
                      ...
                      >
                        <span
                          className={`flex items-center gap-3 ${user.enabled ? "text-red-400" : "text-green-400"}`}
                        >
                          <span
                            className={`p-2 rounded-lg ${user.enabled ? "bg-red-500/20" : "bg-green-500/20"}`}
                          >
                            <span className="material-symbols-outlined text-[20px]">
                        ...
                        <span
                          className={`material-symbols-outlined transition-colors ${user.enabled ? "text-red-500/50 group-hover:text-red-500" : "text-green-500/50 group-hover:text-green-500"}`}
                        >
                          chevron_right
                        </span>
                      </button>
                  ...
                  <div className="space-y-3">
                    ...
                    {onToggleAdminRole && (
                      ...
                      >
                        <span
                          className={`flex items-center gap-3 ${user.isAdmin ? "text-slate-300" : "text-purple-400"}`}
                        >
                          <span
                            className={`p-2 rounded-lg ${user.isAdmin ? "bg-slate-600/30 text-slate-400" : "bg-purple-500/20 text-purple-400"}`}
                          >
                            <span className="material-symbols-outlined text-[20px]">
                              shield_person
                            </span>
                    ...
                    {onToggleSuperAdminRole && (
                      ...
                      >
                        <span
                          className={`flex items-center gap-3 ${user.isSuperAdmin ? "text-slate-300" : "text-yellow-400"}`}
                        >
                          <span
                            className={`p-2 rounded-lg ${user.isSuperAdmin ? "bg-slate-600/30 text-slate-400" : "bg-yellow-500/20 text-yellow-400"}`}
                          >
                            <span className="material-symbols-outlined text-[20px]">
                              verified_user
                            </span>
