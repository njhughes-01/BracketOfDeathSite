      ...
      <form onSubmit={handleSubmit} className="space-y-6 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            />
            {errors.username && (
              <p className="mt-1 text-xs text-red-500 font-bold">{errors.username}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.email && (
              <p className="mt-1 text-xs text-red-500 font-bold">{errors.email}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label htmlFor="firstName" className="block text-xs font-bold text-slate-500 uppercase mb-1">
              First Name
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="lastName" className="block text-xs font-bold text-slate-500 uppercase mb-1">
              Last Name
            </label>
            <input
              type="text"
        ...
        <div>
          ...
          />
          {errors.password && (
            <p className="mt-1 text-xs text-red-500 font-bold">{errors.password}</p>
          )}
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <label className={`flex items-start p-3 rounded-xl border cursor-pointer transition-all ${(formData.roles || []).includes('user') ? 'bg-primary/10 border-primary' : 'bg-background-dark border-white/5 hover:bg-white/5'
              }`}>
              <input
                type="checkbox"
              ...
              />
              <div className="ml-3">
                <span className="block text-sm font-bold text-white">Standard User</span>
                <span className="block text-xs text-slate-500 mt-0.5">Can view tournaments, results, and player profiles.</span>
              </div>
            </label>

            <label className={`flex items-start p-3 rounded-xl border cursor-pointer transition-all ${(formData.roles || []).includes('admin') ? 'bg-red-500/10 border-red-500' : 'bg-background-dark border-white/5 hover:bg-white/5'
              }`}>
              <input
                type="checkbox"
              ...
              />
              <div className="ml-3">
                <span className="block text-sm font-bold text-white">Administrator</span>
        ...
        <div className="flex items-center p-3 bg-white/5 rounded-xl border border-white/5">
          <input
            ...
            disabled={loading}
          />
          <label htmlFor="temporary" className="ml-3 block text-sm font-bold text-slate-300">
