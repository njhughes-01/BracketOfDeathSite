    ...
    <div className="flex flex-col gap-6 pb-20 min-h-screen bg-background-dark p-4">
      ...
      <div className="flex flex-col gap-4 max-w-7xl mx-auto w-full">
        <div className="flex items-center justify-between">
          ...
          <Link
            to="/tournaments"
            className="px-5 py-2.5 bg-[#1c2230] hover:bg-white/5 border border-white/10 text-white text-sm font-bold rounded-xl transition-all flex items-center gap-2"
          >
          ...
          <div>
            ...
            <div className="relative">
              ...
              >
                ...
                <option value="-totalStats.bodFinish">
                  Worst Finish First
                </option>
                <option value="-totalStats.winPercentage">
                  Win % (High to Low)
                </option>
                <option value="totalStats.winPercentage">
                  Win % (Low to High)
                    ...
                    <div className="flex items-center gap-5 w-full md:w-auto">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 mt-1 font-mono">
                          {formatDate(
                            result.tournament?.date || result.createdAt,
                          )}
                        </p>
                      </div>
                    </div>
