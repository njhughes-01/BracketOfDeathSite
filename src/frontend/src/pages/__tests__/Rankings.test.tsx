...
describe('Rankings Page', () => {
    ...
    const setupMock = (data: any = mockLeaderboard, loading = false, error: string | null = null) => {
    ...
    it('renders loading state', () => {
        setupMock(null, true);
        renderPage();
        expect(screen.queryByText(/Failed to load rankings/i)).not.toBeInTheDocument();
