...
const mockPlayers = [
    { id: '1', name: 'John Doe', winningPercentage: 0.75, totalChampionships: 1, gamesPlayed: 20 },
    { id: '2', name: 'Jane Smith', winningPercentage: 0.45, totalChampionships: 0, gamesPlayed: 10 }
];
