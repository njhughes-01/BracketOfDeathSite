    ...
    <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-lg prose-invert max-w-none">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-white mb-4">Regular Scoring</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-white mb-4">Play Let Serves</h2>
          <p className="text-gray-300">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-white mb-4">Match Format</h2>
        ...
        <section className="mb-8 bg-tennis-green/10 p-6 rounded-lg border-2 border-tennis-green">
          <h2 className="text-2xl font-bold text-white mb-4">Have Fun!</h2>
