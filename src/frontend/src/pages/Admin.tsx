                  ...
                  {list.map((tournament) => {
                    ...
                    return (
                      <div
                        ...
                        className="bg-[#1c2230] border border-white/5 rounded-xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 hover:border-white/10 transition-colors"
                      >
                        <div>
                        ...
                        <div className="flex items-center gap-2 w-full sm:w-auto">
                          <Link
                            ...
                            className="flex-1 sm:flex-none px-4 py-2 rounded-lg bg-white/5 text-white text-sm font-bold hover:bg-white/10 transition-colors text-center"
                          >
                            Manage
                          </Link>
                          <Link
                            to={`/tournaments/${tournament._id || tournament.id}`}
                            className="size-9 flex items-center justify-center rounded-lg border border-white/10 hover:bg-white/5 text-slate-400 hover:text-white transition-colors"
                          >
