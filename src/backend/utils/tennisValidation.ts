/**
 * Tennis Score Validation Utilities
...
/**
 * Validate score with optional admin override
 */
...
export function validateScoreForCompletion(
  ...
  // If admin override is provided, allow completion
  ...
  // Otherwise, require admin override
  return {
    canComplete: false,
    requiresOverride: true,
