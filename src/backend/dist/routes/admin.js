...
router.put("/tournaments/:id/finalize", [(0, express_validator_1.param)("id").isMongoId().withMessage("Invalid tournament ID")], validation_1.validateRequest, tournamentAdminController.finalizeTournament);
...
router.delete("/tournaments/:id/register/:playerId", [
    (0, express_validator_1.param)("id").isMongoId().withMessage("Invalid tournament ID"),
    (0, express_validator_1.param)("playerId").isMongoId().withMessage("Invalid player ID"),
], validation_1.validateRequest, tournamentAdminController.unregisterPlayer);
router.post("/tournaments/:id/finalize-registration", [(0, express_validator_1.param)("id").isMongoId().withMessage("Invalid tournament ID")], validation_1.validateRequest, tournamentAdminController.finalizeRegistration);
// Tournament seeding
router.get("/tournaments/:id/seeding-preview", [(0, express_validator_1.param)("id").isMongoId().withMessage("Invalid tournament ID")], validation_1.validateRequest, tournamentAdminController.getSeedingPreview);
// Tournament details with matches
router.get("/tournaments/:id/details", [(0, express_validator_1.param)("id").isMongoId().withMessage("Invalid tournament ID")], validation_1.validateRequest, tournamentAdminController.getTournamentWithMatches);
// Tournament deletion
router.delete("/tournaments/:id", [(0, express_validator_1.param)("id").isMongoId().withMessage("Invalid tournament ID")], validation_1.validateRequest, tournamentAdminController.deleteTournament);
