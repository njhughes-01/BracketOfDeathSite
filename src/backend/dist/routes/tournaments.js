...
router.get('/open', TournamentController_1.tournamentController.listOpen); // New Endpoint
...
router.post('/', auth_1.requireAdmin, TournamentController_1.tournamentController.create);
...
router.put('/:id', auth_1.requireAdmin, validation_1.validateObjectId, TournamentController_1.tournamentController.update);
router.delete('/:id', auth_1.requireAdmin, validation_1.validateObjectId, TournamentController_1.tournamentController.delete);
...
router.post('/generate-seeds', auth_1.requireAdmin, TournamentController_1.tournamentController.generatePlayerSeeds);
router.post('/generate-teams', auth_1.requireAdmin, TournamentController_1.tournamentController.generateTeams);
router.post('/setup', auth_1.requireAdmin, TournamentController_1.tournamentController.setupTournament);
...
// Admin routes
router.post('/bulk-import', auth_1.requireAdmin, TournamentController_1.tournamentController.bulkImport);
