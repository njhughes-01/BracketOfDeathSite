...
const TournamentAdminController_1 = __importDefault(require("../controllers/TournamentAdminController"));
const LiveTournamentController_1 = __importDefault(require("../controllers/LiveTournamentController"));
...
router.get("/:id/registration", validation_1.validateObjectId, TournamentAdminController_1.default.getRegistrationInfo);
...
router.put("/matches/:matchId", auth_1.requireAdmin, LiveTournamentController_1.default.updateMatch);
...
], validation_1.validateRequest, TournamentAdminController_1.default.registerPlayer);
...
], validation_1.validateRequest, TournamentAdminController_1.default.unregisterPlayer);
...
router.get("/:id/live", validation_1.validateObjectId, LiveTournamentController_1.default.getLiveTournament);
router.get("/:id/live-stats", validation_1.validateObjectId, LiveTournamentController_1.default.getLiveStats);
router.get("/:id/player-stats", validation_1.validateObjectId, LiveTournamentController_1.default.getTournamentPlayerStats);
router.get("/:id/stream", validation_1.validateObjectId, LiveTournamentController_1.default.streamTournamentEvents);
router.post("/:id/action", auth_1.requireAdmin, validation_1.validateObjectId, LiveTournamentController_1.default.executeTournamentAction);
router.get("/:id/matches", validation_1.validateObjectId, LiveTournamentController_1.default.getTournamentMatches);
router.post("/:id/checkin", auth_1.requireAdmin, validation_1.validateObjectId, LiveTournamentController_1.default.checkInTeam);
router.post("/:id/generate-matches", auth_1.requireAdmin, validation_1.validateObjectId, LiveTournamentController_1.default.generateMatches);
router.post("/:id/matches/confirm-completed", auth_1.requireAdmin, validation_1.validateObjectId, LiveTournamentController_1.default.confirmCompletedMatches);
