...
describe('ProfileController', () => {
    ...
    describe('getProfile', () => {
        ...
        it('should return 401 if user is not authenticated', async () => {
            ...
            expect(json).toHaveBeenCalledWith({ success: false, error: 'Not authenticated' });
        });
    });
    ...
    describe('updateProfile', () => {
        ...
        it('should update existing player if linked', async () => {
            ...
            (Player.findByIdAndUpdate as jest.Mock).mockResolvedValue(mockUpdatedPlayer);
        ...
        it('should return 400 if required fields are missing', async () => {
            req.body = { gender: 'male' }; // Missing bracketPreference
            await ProfileController.updateProfile(req as any, res as Response);
            expect(res.status).toHaveBeenCalledWith(400);
            expect(json).toHaveBeenCalledWith({ success: false, error: 'Gender and Bracket Preference are required' });
        });
    });
});
