...
describe("TournamentController", () => {
  ...
  describe("getUpcoming", () => {
    it("should return upcoming tournaments", async () => {
      ...
      await tournamentController.getUpcoming(
        mockReq as Request,
        mockRes as Response,
        nextMock,
      );
  ...
  describe("create", () => {
    it("should fail with invalid BOD number", async () => {
      ...
      await tournamentController.create(
        mockReq as Request,
        mockRes as Response,
        nextMock,
      );
  ...
  describe("setupTournament", () => {
    it("should create tournament with valid data", async () => {
      ...
      (Tournament.create as jest.Mock).mockResolvedValue({
        ...basicInfo,
        id: "123",
      });

      await tournamentController.setupTournament(
        mockReq as Request,
        mockRes as Response,
        nextMock,
      );
